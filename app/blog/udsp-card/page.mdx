...
- [sw_udsp-card](https://github.com/crsknr/sw_udsp-card): Example applications
...
- [lib_io_i2c](https://github.com/crsknr/lib_io_i2c): Individual C-based I²C library from [xcore_iot](https://github.com/xmos/xcore_iot)
- [lib_io_i2s](https://github.com/crsknr/lib_io_i2s): Individual C-based I²S library from [xcore_iot](https://github.com/xmos/xcore_iot)
- [lib_mic_array_192](https://github.com/crsknr/lib_mic_array_192): Modified microphone array library for 192kHz
- [lib_xua_192](https://github.com/crsknr/lib_xua_192): Modified USB audio library for 192kHz PDM support
